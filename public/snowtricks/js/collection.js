...
$(document).ready(function () {
    ...
    $collectionHolder.data('index', $collectionHolder.find('.panel-videos').length)
    // finds all the panels in the list and foreach one of them we add a remove button to it
    // add remove button to existing items
    $collectionHolder.find('.panel-videos').each(function () {
...
function addNewForm() {
    ...
    var $panel = $('<div class="panel-videos panel-warning"><div class="panel-heading"></div></div>');
